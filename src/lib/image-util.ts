/**
 * Reads a File object and compresses images to JPEG under max dimension to prevent
 * hitting localStorage quota limits (which fail silently when storing 5MB+ base64).
 */
